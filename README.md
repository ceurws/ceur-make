...
To get started with this, you need a `toc.xml` file ([see this example](/clange/ceur-make/toc.xml)), which you can either write manually, or have generated from an EasyChair archive (see above).
...
This code is licensed under [GPL version 3](/clange/ceur-make/LICENSE) or any later version.
